...
export default async function handler(req, res) {
  ...
  try {
    const { sessao_id, vendedor, origem, etapa_id, pergunta, resposta_dada, resposta_correta, acertou } = req.body || {};
    ...
    await client.query(
      `insert into trilha_respostas
        (sessao_id, vendedor, origem, etapa_id, pergunta, resposta_dada, resposta_correta, acertou)
       values ($1,$2,$3,$4,$5,$6,$7,$8)`,
      [sessao_id, vendedor || null, origem, etapa_id, pergunta || null, resposta_dada ?? null, resposta_correta ?? null, acertou ?? null]
    );
